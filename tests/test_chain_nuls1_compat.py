...
def test_sign_data_deprecated():
    ...
    assert signature
    sign_deprecated: NulsSignatureSecp256k1 = NulsSignatureSecp256k1.sign_data_deprecated(pri_key=private_key,
...
def test_compare_sign_data():
    ...
    sign_deprecated: NulsSignatureSecp256k1 = NulsSignatureSecp256k1.sign_data_deprecated(
        pri_key=private_key.secret,
        digest_bytes=b"x" * (256 // 8))
...
def test_compare_sign_message():
    ...
    sign_deprecated: NulsSignatureSecp256k1 = NulsSignatureSecp256k1.sign_message_deprecated(
        pri_key=private_key.secret,
        message=message)
