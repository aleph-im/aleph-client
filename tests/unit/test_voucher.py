...
MOCK_EVM_VOUCHER_DATA = [(MOCK_VOUCHER_ID, {"claimer": MOCK_ADDRESS, "metadata_id": MOCK_METADATA_ID})]

MOCK_SOLANA_REGISTRY = {
    "claimed_tickets": {"solticket123": {"claimer": MOCK_SOLANA_ADDRESS, "batch_id": "batch123"}},
...
class TestVoucherManager:
    ...
    async def test_fetch_voucher_update(self, voucher_manager):
        ...
        mock_post.content = {
            "nft_vouchers": {MOCK_VOUCHER_ID: {"claimer": MOCK_ADDRESS, "metadata_id": MOCK_METADATA_ID}}
        }
        ...
        with patch(
            "aleph_client.voucher.AlephHttpClient",
            return_value=AsyncMock(__aenter__=AsyncMock(return_value=mock_client), __aexit__=AsyncMock()),
        ):
    ...
    async def test_get_evm_voucher_no_match(self, voucher_manager):
        ...
        voucher_manager._fetch_voucher_update = AsyncMock(
            return_value=[(MOCK_VOUCHER_ID, {"claimer": "0xdifferent", "metadata_id": MOCK_METADATA_ID})]
        )
    ...
    async def test_fetch_solana_vouchers_no_match(self, solana_voucher_manager):
        ...
        mock_registry = {
            "claimed_tickets": {"solticket123": {"claimer": "differentsolana", "batch_id": "batch123"}},
            "batches": {"batch123": {"metadata_id": MOCK_METADATA_ID}},
        }
    ...
    async def test_fetch_solana_vouchers_no_batch(self, solana_voucher_manager):
        ...
        mock_registry = {
            "claimed_tickets": {"solticket123": {"claimer": MOCK_SOLANA_ADDRESS, "batch_id": "nonexistent"}},
            "batches": {},
        }
        solana_voucher_manager._fetch_solana_voucher = AsyncMock(return_value=mock_registry)
